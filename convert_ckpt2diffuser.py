"""
adapted from https://huggingface.co/spaces/diffusers/convert-sd-ckpt/blob/main/convert.py
"""
...
ckpt_path = "models/VAE/MAGIFACTORYTShirt_magifactoryTShirt.ckpt"
# download from  https://raw.githubusercontent.com/CompVis/stable-diffusion/main/configs/stable-diffusion/v1-inference.yaml
config_file = "v1-inference.yaml" 
scheduler_type = "EulerAncestral"
HF_MODEL_DIR = "hf_diffuser"
